        ...
        <div className="space-y-6">
            ...
            <div className="space-y-3">
              ...
              <div>
                ...
                <div className="flex items-center gap-3 mt-2">
                  ...
                  <button onClick={handleToggleStatus} className="px-4 py-2 bg-orange-600 text-white rounded-lg hover:bg-orange-700">
          ...
          <div className="bg-white rounded-xl shadow-lg p-6">
            ...
            <div className="space-y-4">
              ...
              <button onClick={handleScheduleUpdate} className="w-full bg-orange-600 text-white px-6 py-3 rounded-lg hover:bg-orange-700 font-semibold">
                Update Schedule
              </button>
            </div>
          </div>
