            ...
            <div className="p-6 space-y-4">
              ...
              <div className="bg-gray-50 p-4 rounded-lg">
                ...
                <div className="flex flex-wrap gap-2">
                  {viewModal.operatingHours?.daysOpen?.map(day => (
                    <span key={day} className="bg-orange-100 text-orange-700 px-3 py-1 rounded-full text-sm font-medium">
                      {day}
                    </span>
              ...
              <div className="grid grid-cols-3 gap-4">
                <div className="bg-gray-50 p-4 rounded-lg text-center">
                  <p className="text-2xl font-bold text-orange-600">{viewModal.avgRating?.toFixed(1) || '0.0'}</p>
