              ...
              {liveOrders.map((order, i) => (
                <tr key={i} className="border-b dark:border-gray-700 hover:bg-orange-50 dark:hover:bg-orange-900/10">
                  ...
                  <td className="px-4 py-3">
                    <div className="flex space-x-2">
                      <button className="px-3 py-1 bg-orange-600 text-white rounded text-xs font-semibold hover:bg-orange-700">Print</button>
            ...
            <tbody>
              {topItems.map((item, i) => (
                <tr key={i} className="border-b dark:border-gray-700">
                  ...
                  <td className="px-4 py-3">
                    <button className="px-3 py-1 bg-orange-600 text-white rounded text-xs hover:bg-orange-700">Update</button>
                  </td>
                </tr>
              ))}
            </tbody>
